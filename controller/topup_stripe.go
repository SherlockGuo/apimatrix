...
func StripeWebhook(c *gin.Context) {
	...
	logger.LogInfo(ctx, fmt.Sprintf("Stripe webhook 收到请求 path=%q client_ip=%s signature=%q %s", c.Request.RequestURI, c.ClientIP(), signature, common.RedactedBodyLog("body", len(payload))))
